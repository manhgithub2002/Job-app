        ...
        <div class="card-body">
          ...
          <form @submit.prevent="register">
            <div class="form-group">
              ...
              <input v-model="users.name"  class="form-control" type="text" id="fullname" placeholder="Enter your name" required name="name">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <div class="mt-3">
                <div class="custom-control custom-radio">
                  <input v-model="users.roles" type="radio" id="customRadio1" name="role" class="custom-control-input" value="2" checked>
                  <label class="custom-control-label" for="customRadio1">HR</label>
                </div>
                <div class="custom-control custom-radio">
                  <input v-model="users.roles" type="radio" id="customRadio2" name="role" class="custom-control-input" value="1">
                  <label class="custom-control-label" for="customRadio2">Applicant</label>
                </div>
              </div>
            </div>
            <div class="form-group">
